...
(async () => {
	...
	for(let i = 0; i<homepage['PLP-EL-Brand-SeeMore'].items.length;i++){
		let item = homepage['PLP-EL-Brand-SeeMore'].items[i];
	...
	fs.writeFile("results/PLP-EL-Brand-SeeMore.csv",csvContent, 'utf8', function(err) {
		if (err) {
