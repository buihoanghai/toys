...
(async () => {
	...
	for(let i = 0; i<homepage['PLP-FA-Brand-SeeMore'].items.length;i++){
		let item = homepage['PLP-FA-Brand-SeeMore'].items[i];
	...
	fs.writeFile("results/PLP-FA-Brand-SeeMore.csv",csvContent, 'utf8', function(err) {
		if (err) {
