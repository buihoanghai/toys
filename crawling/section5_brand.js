...
(async () => {
	...
	for(let i = 0; i<homepage.section5_brand.items.length;i++){
		let item = homepage.section5_brand.items[i];
	...
	fs.writeFile("results/section5_brand.csv",csvContent, 'utf8', function(err) {
		if (err) {
