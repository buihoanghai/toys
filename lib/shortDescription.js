...
function generateShortDescription(product, index) {
	...
	let template = [
		`Giá ${product} hôm nay, ${phone} ngay để biết bảng báo giá ${product}. Hàng mới bắt đóng thùng giao hàng luôn`,
		`Bán ${product} ${phone} ngay để được báo giá tốt nhất. Do ${product} mua được phân phối trực tiếp từ người đánh bắt đến người tiêu dùng nên có được giá tốt nhất.`,
		`Mua ${product} ${phone} ngay. Giá cả ${product} có đắt hơn hay rẻ hơn năm trước, tình hình thị trường biến động như thế nào.`,
		`${product} bao nhiêu 1 kg? ${phone}, mua ${product} ở sài gòn. Giá rẻ bởi vì bạn đang "mua ${product}" trực tiếp từ người đánh bắt không thông qua đại lý phân phối nào.`,
