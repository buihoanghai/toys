...
function generateShortDescription(product, index) {
	...
	let template = [
		`Giá ${product} hôm nay, ${phone} ngay để biết bảng báo giá ${product}. ${product} mới thu hoạch đóng gói giao hàng luôn nên rất tươi ngon`,
		`Bán ${product} ${phone} ngay để được báo giá tốt nhất. Do ${product} mua được phân phối trực tiếp từ nơi phơi đến người tiêu dùng nên có được giá tốt nhất.`,
		`${product} bán ở đâu? ${phone} ngay. Giá cả ${product} có đắt hơn hay rẻ hơn năm trước, tình hình thị trường biến động như thế nào.`,
		`${product} bao nhiêu 1 kg? ${phone}, mua ${product} ở sài gòn. Giá rẻ bởi vì bạn đang "mua ${product}" trực tiếp từ người phơi không thông qua đại lý phân phối nào.`,
