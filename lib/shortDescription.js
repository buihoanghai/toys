...
function generateShortDescription(product, index) {
	...
	let template = [
		`Giá ${product} hôm nay, ${phone} ngay để biết bảng báo giá ${product}. Thịt mới mổ đóng gói giao hàng luôn nên rất tươi ngon`,
		`Bán ${product} ${phone} ngay để được báo giá tốt nhất. Do ${product} mua được phân phối trực tiếp từ lò mổ đến người tiêu dùng nên có được giá tốt nhất.`,
