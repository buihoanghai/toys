...
function generateShortDescription(product, index) {
	...
	let template = [
		`Giá ${product} hôm nay, ${phone} ngay để biết bảng báo giá ${product}. Nấm mới thu hoạch đóng gói giao hàng luôn nên rất tươi ngon`,
		`Bán ${product} ${phone} ngay để được báo giá tốt nhất. Do ${product} mua được phân phối trực tiếp từ nơi nuôi trồng đến người tiêu dùng nên có được giá tốt nhất.`,
		`${product} bán ở đâu? ${phone} ngay. Giá cả ${product} có đắt hơn hay rẻ hơn năm trước, tình hình thị trường biến động như thế nào.`,
		`${product} bao nhiêu 1 kg? ${phone}, mua ${product} ở sài gòn. Giá rẻ bởi vì bạn đang "mua ${product}" trực tiếp từ người nuôi không thông qua đại lý phân phối nào.`,
		...
		`Mua ${product} ở đâu? ${phone} để nhận báo giá. Mua ${product} bổ sung vào chế độ ăn hằng ngày nhằm cung cấp đầy đủ dinh dưỡng cho cả nhà.`,
	];

	// let template = [
	// 	`Giá ${product} hôm nay, ${phone} ngay để biết bảng báo giá ${product}, đến với ifarmer.vn các bạn có thể lựa chọn cho mình loại ${product} phù hợp nhu cầu.`,
	// 	`Bán ${product} ${phone} ngay để được báo giá tốt nhất. Do ${product} mua được phân phối trực tiếp từ người làm ra đến người tiêu dùng nên có được giá tốt nhất.`,
	// 	`Mua ${product} ${phone} ngay. Giá cả ${product} có đắt hơn hay rẻ hơn năm trước, tình hình thị trường biến động như thế nào.`,
	// 	`${product} bao nhiêu 1 kg, ${phone}, mua ${product} ở sài gòn. Giá rẻ bởi vì bạn đang "mua ${product}" trực tiếp từ người nông dân không thông qua đại lý phân phối nào.`,
	// 	`Cần mua ${product} ở sài gòn ${phone} để biết bảng báo giá ${product} đến với ifarmer.vn các bạn có thể lựa chọn cho mình loại ${product} phù hợp nhu cầu.`,
	// 	`${product} giá rẻ hcm, ${phone} để nhận báo giá. Mua ${product} bổ sung vào chế độ ăn hằng ngày nhằm cung cấp đầy đủ dinh dưỡng cho cả nhà.`,
	// ];
	//
	// let template = [
